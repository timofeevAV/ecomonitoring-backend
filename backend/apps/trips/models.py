...
class Trip(models.Model):
    name = models.CharField(max_length=100, default='Новый выезд')
...
# def delete_scheme_file(sender, instance, **kwargs):
#     if instance.scheme:
#         if os.path.isfile(instance.scheme.path):
#             os.remove(instance.scheme.path)


# @receiver(pre_save, sender=Trip)
# def delete_old_scheme_file(sender, instance, **kwargs):
#     if instance.pk:
#         old_instance = sender.objects.get(pk=instance.pk)
#         if old_instance.scheme and old_instance.scheme != instance.scheme:
#             if os.path.isfile(old_instance.scheme.path):
#                 os.remove(old_instance.scheme.path)
